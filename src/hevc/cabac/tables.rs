//! CABAC state transition and range tables (clause 9.3.4.3).

/// `rangeTabLps[pStateIdx][qRangeIdx]`, Table 9-46.
...
/// `transIdxLps[pStateIdx]`, Table 9-47.
...
/// `transIdxMps[pStateIdx]`, Table 9-47.
